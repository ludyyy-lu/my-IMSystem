...
type MessageHandler func(svcCtx *svc.ServiceContext, fromUserId int64, msg Message)
...
func RouteMessage(svcCtx *svc.ServiceContext, fromUserId int64, msg Message) {
